...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  8 14:37:41 2018
...
def calculateAccuracy():
    ...
    y_true =[]
    print('Starting Feature Extraction Job from testAudio Files. I tmight take some time...!' )
    for folder in folders :
        ...
        for file in files:
            print('Starting Audio Featuure Extraction for {} speaker whic has {} files'.format(folder,len(files)))
            testPath = subFolder_path + file
            y_predict.append(testSpeaker(testPath))
...
# Verify the Speaker : 
# =============================================================================
#print(verify('/Users/as186194/Desktop/TestData/chocoholic/wav/eti0202.wav','chocoholic'))
